...
namespace IdentityTranslationLite.IotHubClient
{
    ...
    /// </summary>
    /// <remarks>
    /// Based on https://github.com/fbeltrao/iotedge-di-module
    /// </remarks>
    public class ModuleClientAdapter : IModuleClient
    {
        private readonly Microsoft.Azure.Devices.Client.ModuleClient moduleClient;

        /// <summary>
        /// Creates a new instance of <see cref="ModuleClientAdapter"/>
        /// </summary>
        /// <param name="moduleClient"></param>
        public ModuleClientAdapter(Microsoft.Azure.Devices.Client.ModuleClient moduleClient)
        {
